...
(A) .Rmd Line numbers where at least two different data sources are imported:  Line 34 & 53


(B) .Rmd Line numbers for inspecting data intake:  Line 37, 38, 56 & 57
...
(A) .Rmd Line number(s) for general data wrangling: Line 105 to 128


(B) .Rmd Line number(s) for a join operation: Line 86 & 87


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): Line 121, 145


(D) .Rmd Line number(s) for use of regular expressions: Line 108, 112, 202


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: Line - 122 to 127 


(F) .Rmd Line number(s) for use of user-defined functions: Line 165 to 181, 


(G) .Rmd Line number(s) for use of loops and/or control flow: Line 200 to 203
...
(A) .Rmd Line number(s) for use of mulitple different geoms:  Line 229 to 238

(B) .Rmd Line number(s) for use of multiple aesthetics:  Line 229

(C) .Rmd Line number(s) for use of layered graphics:  Line 229 to 238
